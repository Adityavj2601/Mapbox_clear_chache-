...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener, SpeechAnnouncementListener, NavigationListener, MilestoneEventListener, LocationEngineCallback<LocationEngineResult> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("before Execute", "working");
        ConnectBT b = new ConnectBT();
        b.execute();
        Log.d("After Execute", "working");
...
//                        NavigationViewOptions options2 = builder.build();
                        ...
                        Thread t1 = new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                int num = sarr.size();
                                int counter = 0;
                                Log.d("numm", String.valueOf(sarr.size()));
                                int value = 0;
                                int counter2 = 0;
                                ...
                                while (value != num) {
                                    ...
                                    try {
                                        //"/system/bin/logcat -W | tail -n 1"
                                        //String[]  comand = new String[] {"logcat" ,"-w"};
                                        ...
                                        while ((line = br.readLine()) != null) {
                                            ...
                                            if (line.contains(" mediaplayer went away with unhandled events")) {
                                                if (!demo.equals(line)) {
                                                    ...
                                                    Log.v("final_destination", (String) sarr.get(value));
                                                    value++;
                                                    demo = line;
        ...
        protected Void doInBackground(Void... devices) //while the progress dialog is shown, the connection is done in background
        {
            try {
                if (btSocket == null || !isBtConnected) {
                    ...
                    Log.d("btsocket in ", btSocket.toString());
                    Log.d("flag  Before", String.valueOf(flag));

                    flag = 1;
                    Log.d("flag  After", String.valueOf(flag));
                }
            } catch (IOException e) {
